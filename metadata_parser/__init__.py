...
class MetadataParser(object):
    ...
    def __init__(
                ...
                if defer_fetch:
                    def deferred_fetch():
                        ...
                        self.parse(html, support_malformed=support_malformed, 
                                   use_best_available_html_parser=use_best_available_html_parser)
                        return
        ...
        if html:
            self.parse(html, support_malformed=support_malformed, use_best_available_html_parser=use_best_available_html_parser)
    ...
    def parse(self, html, support_malformed=None, use_best_available_html_parser=False):
        """
